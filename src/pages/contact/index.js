...
const ContactPage = ({ header, getIntouch }) => {
    ...
    const socialLinks = [
        { name: 'LinkedIn', url: 'https://www.linkedin.com/company/mars-robotics/posts/?feedView=all', icon: 'linkedin' },
        { name: 'Facebook', url: 'https://www.facebook.com/marsrobotic/', icon: 'facebook' },
     ];
